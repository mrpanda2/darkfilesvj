...
DB_URI = environ.get("DB_URI", "mongodb+srv://darkfiles:darkfiles@darkfiles.zjeqk.mongodb.net/?retryWrites=true&w=majority&appName=darkfiles")
DB_NAME = environ.get("DB_NAME", "darkfiles")
